...
def get_slot_mmachine_spin(rows,cols,symbols):
    all_symbols = []
...
def spin(balance):
    ...
    while True:
        ...
        if total_bet > balance:
            print(f"You do not have enoogh for this bet, you current balance is {balance}")
        else:
            break
    print(f"You are betting ${bet} on {lines} lines. Total bet is equal to: ${total_bet}")

    slot = get_slot_mmachine_spin(ROWS,COLS,symbol_count)
